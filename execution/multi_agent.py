...
Usage:
    python3 execution/multi_agent.py --init-wave wave-1.json
    python3 execution/multi_agent.py --claim
    python3 execution/multi_agent.py --complete <taskId> [--tokens N] [--commits N]
    python3 execution/multi_agent.py --status [--json]
    python3 execution/multi_agent.py --dashboard [--json]
    python3 execution/multi_agent.py --preview [FILE] [--json]
    python3 execution/multi_agent.py --abandon <taskId>
    python3 execution/multi_agent.py --heartbeat
    python3 execution/multi_agent.py --reclaim [--json]
    python3 execution/multi_agent.py --merge [--json]
    python3 execution/multi_agent.py --summary [--json]
    python3 execution/multi_agent.py --log [--json]
"""
