...
- NEXT STEP: find the first uncompleted step (line starting with `[ ]`) for the current feature in todo.md. Show the step number and description (e.g. "Step 4 — dispatcher wiring"). If all steps are complete, show "All steps complete — ready for retro".
