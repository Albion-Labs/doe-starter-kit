...
- **proof/run.py** -- `git_fixture` support for `$CLAUDE_PROJECT_DIR`-anchored hooks; escape-valve env scrub; kit-anchored hook cwd; provenance now derived from the manifest so it can never lag the corpus.
