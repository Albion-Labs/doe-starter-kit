...
- **26 flat directives + 9 nested directives** -- ~135 negation phrases rewritten to positive form. Each rewrite names the safe API, the legitimate workflow, or the closed set of allowed values rather than enumerating prohibitions.
