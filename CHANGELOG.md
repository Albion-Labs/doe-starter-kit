...
**Version bump rationale**: minor for the `/sync-doe` feat. The worktree auto-detection layer previously queued for v1.62.0 (per v1.61.5's footer) is rebumped to **v1.63.0** in the release queue. Source: alkyion bootstrap session 1 audit — the slash command's "release directly on main" Step 12 was caught contradicting the canonical directive's "opens the kit PR" framing.
<!-- /hero -->
